...
const borrowSlice = createSlice({
 ...
 export const fetchUsersBorrowedBooks = () => async (dispatch) => {
    ...
    await axios.get("http://localhost:4000/api/v1/borrow/user", {withCredentials : true}).then((res) => {
...
export const fetch allBorrowedBooks = () => async (dispatch) => {
    dispatch(borrowSlice.actions.fetchAllBorrowedBooksRequest());
    await axios.get("http://localhost:4000/api/v1/borrow/all", {withCredentials : true}).then((res) => {
...
export  const recordBook = (email,id)) => async (dispatch) => {
    ...
    await axios.post("http://localhost:4000/api/v1/borrow", {email, id},
         {
...
export const returnBook = (email,id) => async (dispatch) => {
    ...
    await axios.put("http://localhost:4000/api/v1/borrow/return", {
        email,
        id,
    },
    {
